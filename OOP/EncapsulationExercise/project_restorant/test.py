from EncapsulationExercise.project_restorant.beverage.beverage import Beverage
from EncapsulationExercise.project_restorant.food.soup import Soup
from EncapsulationExercise.project_restorant.product import Product
