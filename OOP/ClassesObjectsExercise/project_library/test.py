from ClassesObjectsExercise.project_library.library import Library
from ClassesObjectsExercise.project_library.user import User
from ClassesObjectsExercise.project_library.registration import Registration
...
library.get_book('J.K.Rowling', 'The Prisoner of Azkaban', 17, user)
